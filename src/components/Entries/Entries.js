    ...
    <div id="entries" className="entries">
      ...
      <div className="entry-wrapper">
        ...
        <p className="blog-body">
          One method to installing python pandas onto your machine. First you
          open a new window in VSCode by navigating to the top of the screen and
          and clicking <span>File New Window</span>. From there you are going to
          open a new terminal either by selecting command + J or by navigating
          up to the tip of the screen again and selecting View Terminal. #2:
          From the terminal create a python folder. If you want this folder to
          live on your Desktop you will use the following command{" "}
          <span>mkdir python</span>. This will create a new folder on your
