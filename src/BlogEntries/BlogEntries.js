  ...
  return (
    <div id="entries">
      <p className="blog-body">
        ...
        the screen and and clicking <span>File --> New Window</span>. From there
        you are going to open a new terminal either by selecting command + J or
        by navigating up to the tip of the screen again and selecting View -->
        ...
        terminal you can simply enter <code>touch filename.py</code>. In the new
        file at the top <code>import pandas as pd</code> pd can be altered and
        named whatever name you want.
